...
char *unused;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_occ_inv_all");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving init_occ_inv_all");
    return (1);
}

int
occ_inv_all (unused, fdbk_info, inst)
char *unused;
...
int inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering occ_inv_all");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving occ_inv_all");
...
int
close_occ_inv_all (inst)
int inst;
{
    long i;

    PRINT_TRACE (2, print_string, "Trace: entering close_occ_inv_all");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving close_occ_inv_all");
    return (1);
}
