...
int init_lang_model_wt_cf_lm(SPEC* spec, char* unused)
{
    DIR_ARRAY dir_array;
	long ctype ;
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_lang_model_wt_cf_lm");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving init_lang_model_wt_cf_lm");
    return (1);
}
...
*/
int lang_model_wt_cf_lm(VEC* invec, VEC* outvec, int inst)
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering lang_model_wt_cf_lm");
	...
	*/
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving lang_model_wt_cf_lm");
    return 1 ;
}

int close_lang_model_wt_cf_lm(int inst)
{
	long ctype ;

    PRINT_TRACE (2, print_string, "Trace: entering close_lang_model_wt_cf_lm");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving close_lang_model_wt_cf_lm");
    return (1);
}
