#ifdef RCSID
static char rcsid[] = "$Header: /home/smart/release/src/libindexing/parse_phrase.c,v 11.2 1993/02/03 16:51:11 smart Exp $";
#endif
...
static SPEC_PARAM spec_args[] = {
    ...
    {"index.parse.locale",         getspec_string, (char *) &locale_buf},
    };
...
char *param_prefix;
{
    ...
    if (NULL == (ip->locale = setlocale(LC_ALL, locale_buf)))
        return (UNDEF);
