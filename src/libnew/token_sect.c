#ifdef RCSID
static char rcsid[] = "$Header: /home/smart/release/src/libindexing/token_sect.c,v 11.2 1993/02/03 16:51:18 smart Exp $";
#endif
...
int inst;
{
   ...
   /* Determine maximum size of buffer needed to hold all the document's
    ...
    while (ptr < end_ptr) {
	    ...
	    /* Should there be a t_sect->num_tokens++ here? */
        ...
        switch (ip->char_type[*ptr]) {
          ...
          case T_DP:
            ...
            /* else this is a digit ('-' or '+') and we fall through */
          case T_D:
            do {
                *buf_ptr++ = *ptr++;
