...
int
init_rerank_cluster_nosel (spec, unused)
SPEC *spec;
char *unused;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_rerank_cluster_nosel");
    ...
    if (top_wanted <= 0) {
	set_error(SM_ILLPA_ERR, "top_wanted", "init_rerank_cluster_nosel");
	return(UNDEF);
    }
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving init_rerank_cluster_nosel");
...
int
rerank_cluster_nosel (in_file, out_file, inst)
char *in_file;
char *out_file;
int inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering rerank_cluster_nosel");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving rerank_cluster_nosel");
    return (1);
}

int
close_rerank_cluster_nosel (inst)
int inst;
{
    int i;

    PRINT_TRACE (2, print_string, "Trace: entering close_rerank_cluster_nosel");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving close_rerank_cluster_nosel");
    return (0);
}
