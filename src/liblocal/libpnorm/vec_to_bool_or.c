#ifdef RCSID
static char rcsid[] = "$Header: vec_to_bool_or.c,v 8.0 85/06/03 17:37:46 smart Exp $";
#endif
...
/* This program transforms a vector query into a flat pnorm query by
   simply ORing all of the terms and using pvalue 1.0 */
...
static SPEC_PARAM spec_args[] = {
    ...
    TRACE_PARAM ("convert.vec_to_bool_or.trace")
    };
...
int
init_vec_to_bool_or (spec, unused)
SPEC	*spec;
char	*unused;
{
    ...
    PRINT_TRACE(2,print_string,"Trace: entering/leaving init_vec_to_bool_or");
    return (0);
...
int
vec_to_bool_or (vec_name, pvec_name, inst)
char	*vec_name;
char	*pvec_name;
int	inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering vec_to_bool_or");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving vec_to_bool_or");
    return (1);
} /* vec_to_bool_or */


int
close_vec_to_bool_or (inst)
int	inst;
{
    PRINT_TRACE (2,print_string,"Trace: entering/leaving close_vec_to_bool_or");
    return (0);
} /* close_vec_to_bool_or */
