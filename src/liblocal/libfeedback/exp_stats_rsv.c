#ifdef RCSID
static char rcsid[] = "$Header: /home/smart/release/src/libfeedback/exp_rsv.c,v 11.0 1992/07/21 18:20:39 chrisb Exp $";
#endif
...
char *unused;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_exp_rsv");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving init_exp_rsv");
    return (1);
}

int
exp_rsv (unused, fdbk_info, inst)
char *unused;
...
int inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering exp_rsv");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving exp_rsv");
    return (1);
}
...
int inst;
{
    PRINT_TRACE (2, print_string, "Trace: entering close_exp_rsv");

    if (UNDEF == close_fdbkstats (fdbk_fd))
        return (UNDEF);

    PRINT_TRACE (2, print_string, "Trace: leaving close_exp_rsv");
    return (0);
}
