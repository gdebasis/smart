...
char *unused;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_exp_nonrand");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving init_exp_nonrand");
    return (1);
}


int
exp_nonrand (unused, fdbk_info, inst)
char *unused;
...
int inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering exp_nonrand");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving exp_nonrand");
    return (1);
}


int
close_exp_nonrand (inst)
int inst;
{
    PRINT_TRACE (2, print_string, "Trace: entering close_exp_nonrand");

    if (UNDEF == close_local_exp_reldoc(exp_rel_doc_inst))
        return (UNDEF);

    PRINT_TRACE (2, print_string, "Trace: leaving close_exp_nonrand");
    return (0);
}
