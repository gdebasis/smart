 ...
 *2 wt_fdbk_sel_q (unused1, fdbk_info, inst)
 *3   char *unused1;
 *3   FEEDBACK_INFO *fdbk_info;
 *3   int inst;
 *4 init_wt_fdbk_sel_q (spec, unused)
 *5   "feedback.alpha"
 *5   "feedback.beta"
 *5   "feedback.gamma"
 *5   "feedback.weight.trace"
 *4 close_wt_fdbk_sel_q (inst)
...
int
init_wt_fdbk_sel_q (spec, unused)
SPEC *spec;
char *unused;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_wt_fdbk_sel_q");

    saved_spec = spec;

    PRINT_TRACE (2, print_string, "Trace: leaving init_wt_fdbk_sel_q");
    return (1);
}

int
wt_fdbk_sel_q (unused, fdbk_info, inst)
char *unused;
...
int inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering wt_fdbk_sel_q");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving wt_fdbk_sel_q");

    return (1);
}

int
close_wt_fdbk_sel_q (inst)
int inst;
{
    PRINT_TRACE (2, print_string, "Trace: entering/leaving close_wt_fdbk_sel_q");
    return (0);
}
